...
The draft ACL specifications are 8,587 mt, 13,165 mt, and 17,187 mt in 2025-2027 respectively.
...
kbl(proj_rev %>% select(c(Year, Price, Revenue, 'Revenue ChangeA', 'Revenue ChangeB' )), digits=0,booktabs=T, align=c("l",rep('r',times=3)), caption =  "Projected landings (mt), prices (real 2023 USD/mt), revenues (real 2023 USD) and revenue change relative to the two baselines for 2025-2027 draft specifications") %>%
    #column_spec(5:8, width = "2cm")
...
Table \ref{tab:prices_revenues_table} summarizes the annual prices, revenues, and changes of the draft action relative to the baseline. The draft action will result higher landings and revenues compared to the baseline. The increase in landings results in modestly lower Atlantic herring prices. 

When discounted at 3\%, the model projects an **increase in revenues of `r proj_rev2$rev3A`** compared to Baseline A.   When discounted at a 7% discount rate, the model projects an **increase in revenues of `r proj_rev2$rev7A`** compared to Baseline A.  

When discounted at 3\%, the model projects an **increase in revenues of `r proj_rev2$rev3B`** compared to Baseline B.   When discounted at a 7% discount rate, the model projects an **increase in revenues of `r proj_rev2$rev7B`** compared to Baseline B.  
...
The projected decrease in gross revenues and Atlantic herring revenues is moderate.  In 2025-2026, average gross receipts for small firms are projected to increase moderately.
