...
kbl(proj_rev %>% select(c(Year, Price, Revenue, 'Revenue Change')), digits=0,booktabs=T, align=c("l",rep('r',times=3)), caption =  "Projected landings (mt), prices (real 2023 USD/mt), revenues (real 2023 USD) and revenue change relative to the baseline for 2025-2027 draft specifications") %>%
    #column_spec(5:8, width = "2cm")
...
```{r prices_revenuesCR_table_compute, eval=TRUE, results='hide'}
# 2024 quota is 19141mt
...
```{r prices_revenuesCR, ref.label=c('prices_revenuesCR_table_compute'),eval=TRUE}
```
