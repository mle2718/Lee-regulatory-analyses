...
When discounted at 3\%, the model projects an **increase in revenues of `r proj_rev2$rev3A`** compared to Baseline A over three years.   When discounted at a 7% discount rate, the model projects an **increase in revenues of `r proj_rev2$rev7A`** compared to Baseline A over three years.  
