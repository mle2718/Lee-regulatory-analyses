...
export.geotiff.path = file.path(ML.PROJECT.PATH,"outputs","geotiff",PROJECT.NAME,paste0(PROJECT.NAME,"_AGGREGATED_2019-12-10"))
...
outfilestub<-"hrgmack_revenue_allgears_avg"
