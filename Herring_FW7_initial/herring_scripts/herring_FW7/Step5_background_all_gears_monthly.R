...
export.geotiff.path = file.path(ML.OUTPUT.GEOTIFF.PATH,paste0(PROJECT.NAME,"_","2019-12-06"))
...
## OUTPUT LOCATIONS
#####################################################
exportfolder = file.path(ML.OUTPUT.IMAGE.PATH)
...
#strip off the year
parsed_list1$type <- as.character(substr(parsed_list1$type,1,nchar(parsed_list1$type)-4))
parsed_list1$YEAR <- as.character(substrRight(parsed_list1$NAME,4))
