...
ML.OUTPUT.GEOTIFF.PATH=file.path(ML.PROJECT.PATH,"outputs","geotiff",PROJECT.NAME,paste0(PROJECT.NAME,"_2019-12-10"))

export.geotiff.path = file.path(ML.OUTPUT.GEOTIFF.PATH,paste0(PROJECT.NAME,"_","2019-12-10"))
...
parsed_list1a$YEAR = as.numeric(str_sub(parsed_list1a$NAME,-4))
