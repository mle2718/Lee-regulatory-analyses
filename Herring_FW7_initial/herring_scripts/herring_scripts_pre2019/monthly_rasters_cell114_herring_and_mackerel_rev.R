...
year1<-do.call(rbind, lapply(my_year1, data.frame, stringsAsFactors=FALSE))
...
my_output1<-data.frame(y1,year1,b1,blockq1)


write.table(my_output1,(file.path(YOUR.STORAGE.PATH, paste(sp1,"monthly_extra_114_only.csv", sep=""))), sep=",", row.names=FALSE, col.names=c("month", "year","block", "quantity"))  
