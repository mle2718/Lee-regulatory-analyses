...
my_output1<-data.frame(y1,name,inside6)


write.table(my_output1,(file.path(YOUR.STORAGE.PATH, "hma1A_herring_landings.csv")), sep=",", row.names=FALSE, col.names=c("month", "name", "in1A"))  
