...
write.table(my_output1,(file.path(YOUR.STORAGE.PATH, paste(sp1,"monthly_extra_inshore.csv", sep=""))), sep=",", row.names=FALSE, col.names=c("month", "quantity6", "quantity12", "aggregate q"))  
