...
#
    for (working_gear in c("allgears","BOT","MWT",'PUR')){
      for (working_regime in c(1,2)){
        for (working_time in c(0,1)){
          print(paste("The metier is", working_gear, "and the regime is ",working_regime , "and the months are is ", working_time))
          ...
          cutnames<-paste0(working_gear,"_timeblock_", working_time,"_regime_", working_regime, ".csv")
