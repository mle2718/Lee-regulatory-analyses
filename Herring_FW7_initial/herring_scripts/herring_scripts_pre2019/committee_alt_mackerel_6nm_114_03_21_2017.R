...
my_output1<-data.frame(y1,name,inside6, annualq1)


write.table(my_output1,(file.path(YOUR.STORAGE.PATH, "committe_mackerel_alt_6nm_114.csv")), sep=",", row.names=FALSE, col.names=c("month", "name", "quantity6", "aggregate q"))  
