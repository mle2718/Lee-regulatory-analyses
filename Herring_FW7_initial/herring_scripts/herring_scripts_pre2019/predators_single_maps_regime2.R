...
### Set Up for Confidentiality Check  
 ...
 START.YEAR <- 2008  # This means the code will run for any year between START.YEAR and END.YEAR
 END.YEAR <- 2015
...
# Min-Yang's code changes for reclassification to 1-6 from value bins
  ...
  cutnames<-gsub("/", "_", cutnames)
  cutnames<-paste0(cutnames,"_r2.csv")
...
# Name for 'RAW' rasters - the original file
    pdf_filename=paste0(temp_rgrouplist$GRP_txt[1],"_r2.pdf")
