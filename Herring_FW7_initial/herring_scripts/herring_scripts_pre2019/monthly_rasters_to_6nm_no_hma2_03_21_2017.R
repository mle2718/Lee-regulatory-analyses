...
write.table(my_output1,(file.path(YOUR.STORAGE.PATH, "monthly_extra_inshore_nohma2.csv")), sep=",", row.names=FALSE, col.names=c("month", "name", "quantity6", "quantity12", "quantity25", "quantity50", "aggregate q"))  
