...
parsed_list1$YEAR <-   substrRight(parsed_list1$NAME,4)
...
parsed_list1$REGIME<-2000
parsed_list1$REGIME[which(parsed_list1$YEAR>=2001 & parsed_list1$YEAR<=2005)]<-1
parsed_list1$REGIME[which(parsed_list1$YEAR>=2006 & parsed_list1$YEAR<=2010)]<-2
parsed_list1$REGIME[which(parsed_list1$YEAR>=2011 & parsed_list1$YEAR<=2015)]<-3
...
outfilename<-paste0("herring_pounds_",myr,".tif")
