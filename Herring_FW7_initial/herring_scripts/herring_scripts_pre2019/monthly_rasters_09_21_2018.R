...
write.table(my_output1, file.path(YOUR.STORAGE.PATH, paste0("monthly_herring_mackerel",todaysdate,".csv")), sep=",", row.names=FALSE, col.names=c("month", "name", "quantity6", "quantity12", "quantity25", "quantity50", "aggregate q"))  
