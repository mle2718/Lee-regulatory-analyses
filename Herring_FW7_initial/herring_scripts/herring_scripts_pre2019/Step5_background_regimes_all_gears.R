...
YOUR.DATA.PATH=file.path(YOUR.PROJECT.PATH,"HERRING_ALL_GEARS_09162016") #This has monthly MWT and PUR yearly in it
...
for (myr in 1:2)  {
   yearfileswanted <- parsed_list1[which(parsed_list1$REGIME==myr),]
...
outfilename<-paste0("herring_pounds_allgears_regime_",myr,".tif")
