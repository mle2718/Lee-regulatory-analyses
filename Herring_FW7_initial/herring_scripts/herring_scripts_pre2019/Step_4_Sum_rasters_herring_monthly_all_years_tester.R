  ...
  SSB.LOCAL=file.path("/run/user/1877/gvfs/smb-share:server=net,share=work5/socialsci") #THIS Is what you need to run local
  ...
  exportfolder = file.path(ML.PROJECT.PATH,"HERRING_A8_09162016")
...
rm(list="FILE_INFO")
  ...
  for (yr in START.YEAR:END.YEAR)  {
    ...
    FINALa=FINALa[which(FINALa$GEARCODE %in% c("OTM","PTM","PUR", "OTF", "OHS", "OTR", "OTT", "OTS", "OTC")),] # <-MWT and PUR
  ...
  FINAL$MY_MARGIN<-paste(FINAL$MY_GEAR,FINAL$MONTH,"herring", sep="_")
