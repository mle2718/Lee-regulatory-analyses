...
YOUR.DATA.PATH=file.path(YOUR.PROJECT.PATH,"A8_ALL_HERR_MACK_REVENUE_2017-10-13") #This has monthly MWT and PUR yearly in it
...
## OUTPUT LOCATIONS
#####################################################
exportfolder = file.path(YOUR.PROJECT.PATH,paste0("committee_alt",todaysdate))
