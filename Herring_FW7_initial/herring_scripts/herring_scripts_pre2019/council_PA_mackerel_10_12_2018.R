...
YOUR.DATA.PATH=file.path(YOUR.PROJECT.PATH,"MACKEREL_MWT_10252017")
...
#6nm buffer
council_PA = readOGR(dsn=file.path(ML.GIS.PATH,"herring_A8", "Final_A8_Localized_Depletion_Closure"), layer="Final_A8_Localized_Depletion_Closure", verbose=F)
council_PA = spTransform(council_PA, CRS=PROJ.USE)
...
for (i in 1:nrow(parsed_list1a)) {
  ...
  rvalsPA<-extract(myras,council_PA) #Subset raster data within 6nm
