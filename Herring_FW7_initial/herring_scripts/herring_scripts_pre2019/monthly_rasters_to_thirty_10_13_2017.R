...
write.table(my_output1,(file.path(YOUR.STORAGE.PATH, "monthly_herr_mack_rev_30sq.csv")), sep=",", row.names=FALSE, col.names=c("month", "block", "name","quantity", "aggregate q"))  
