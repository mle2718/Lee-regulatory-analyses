...
mypat1<-glob2rx("MWT*herringQTYKEPT*.tif")
...
parsed_list1a$MONTH = str_sub(parsed_list1a$NAME,5,6)
parsed_list1a$MONTH = gsub("_","",parsed_list1a$MONTH)
parsed_list1a$outname = gsub("herringQTYKEPT","herringQ",parsed_list1a$NAME)
