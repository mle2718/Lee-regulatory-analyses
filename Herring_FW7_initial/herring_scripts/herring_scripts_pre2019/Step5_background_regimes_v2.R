...
## OUTPUT LOCATIONS
#####################################################
exportfolder = file.path(YOUR.PROJECT.PATH,paste0("A8_background_",todaysdate))
...
for (myg in gearlist){ 
for (myr in 1:2)  {
   yearfileswanted <- parsed_list1[which(parsed_list1$REGIME==myr & parsed_list1$GEAR==myg),]
...
outfilename<-paste0("herring_pounds_",myg,"_regime_",myr,".tif")
