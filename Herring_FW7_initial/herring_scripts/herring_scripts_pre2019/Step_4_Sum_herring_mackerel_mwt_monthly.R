...
exportfolder = file.path(ML.PROJECT.PATH,"A8_HERRING_MACK_REVENUE_11282016")
...
for (yr in START.YEAR:END.YEAR)  {
  ...
  FINAL$MY_MARGIN<-paste(FINAL$MY_GEAR,FINAL$MONTH,"HER_MACK_", sep="_")
