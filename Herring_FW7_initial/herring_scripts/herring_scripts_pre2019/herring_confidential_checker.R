...
#FINAL_wy=FINAL_w[which(FINAL_w$summer_months==working_time),]
FINAL_wy=FINAL_w[which(FINAL_w$REGIME==working_regime),]
...
flwy=fla[which(fla$IDNUM%in%FINAL_wy$IDNUM),]
