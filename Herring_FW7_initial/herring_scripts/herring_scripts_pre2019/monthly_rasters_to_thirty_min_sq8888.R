...
YOUR.DATA.PATH=file.path(YOUR.PROJECT.PATH,"2016-07-29_rasterexport") #This has monthly MWT and PUR yearly in it
...
write.table(my_output1,(file.path(YOUR.STORAGE.PATH, paste(sp1,"monthly_8888_extra_30sq.csv", sep=""))), sep=",", row.names=FALSE, col.names=c("month", "block", "quantity", "aggregate q"))  
