...
write.table(my_output1,(file.path(YOUR.STORAGE.PATH, "monthly_extra_herr_mack_rev_no_hma2_30sq.csv")), sep=",", row.names=FALSE, col.names=c("month", "block", "name","quantity", "aggregate q"))  
