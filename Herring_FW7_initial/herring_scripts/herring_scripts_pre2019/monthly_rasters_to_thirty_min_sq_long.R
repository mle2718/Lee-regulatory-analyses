...
YOUR.DATA.PATH=file.path(YOUR.PROJECT.PATH,"2016-03-15_rasterexport") 
...
YOUR.DATA.PATH=file.path(YOUR.PROJECT.PATH,"2016-06-10_rasterexport") #This has monthly MWT and PUR yearly in it
...
sp1<-"PUR_168"
z<-paste0(sp1,"*8888.tif")
mypat1<-glob2rx(z)

sp2<-"MWT_168"
z2<-paste0(sp2,"*8888.tif")
mypat2<-glob2rx(z2)
...
write.table(my_output1,(file.path(YOUR.STORAGE.PATH, paste(sp1,"monthly8888.csv", sep=""))), sep=",", row.names=FALSE, col.names=c("month", "block", "quantity", "aggregate q"))  

write.table(my_output2,(file.path(YOUR.STORAGE.PATH, paste(sp2,"monthly8888.csv", sep=""))), sep=",", row.names=FALSE, col.names=c("month", "block", "quantity", "aggregate q"))  
