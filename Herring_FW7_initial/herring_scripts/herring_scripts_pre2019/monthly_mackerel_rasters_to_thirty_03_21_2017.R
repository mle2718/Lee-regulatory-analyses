...
my_output1<-data.frame(y1,b1,name,blockq1, annualq1)


write.table(my_output1,(file.path(YOUR.STORAGE.PATH, "mackerel_monthly_extra_30sq.csv")), sep=",", row.names=FALSE, col.names=c("month", "block", "name","quantity", "aggregate q"))  
