...
This assumes that fishing in the future in the "other fisheries" is similar to the 2018-2020 average and that  proportional expansions or decreases at the firm level would occur relative to the 2018-2020 average. So, if a firm "exited" prior to 2018, it will not have any revenue if even if conditions improve.  
...
## Summary of Impacts
The expected economics effects (benefits/costs) of each the Action 1 and 2, relative to the no action baseline for the herring fishery, are discussed throughout Sections Y  and Z  of this document. <!--Action 2 is expected to have minimal impacts on the fishery, so attention is focused on Action 1. maybe-->
