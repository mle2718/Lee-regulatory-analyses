...
export delimited year vessels herring mackerel squid menhaden other using ${my_results}/RFA_hrg_only_species_comp_vessels.csv, replace
...
export delimited year size firms vessels total herring mackerel squid menhaden other using ${my_results}/RFA_hrg_only_species_comp_firms.csv if active==1 & firms>=3, replace
